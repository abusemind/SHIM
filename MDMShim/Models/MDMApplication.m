...
static NSArray *fakeURLs;

@implementation MDMApplication

//TODO: delete fake urls
+(void) initialize
{
    fakeURLs = [NSArray arrayWithObjects:
...
- (void) setAppId:(int)appId
{
    ...
    _iconUrl = [fakeURLs objectAtIndex:(_appId % [fakeURLs count])];
