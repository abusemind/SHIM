...
CGFloat SVProgressHUDRingThickness = 3;
#else
CGFloat SVProgressHUDRingRadius = 14;
...
+ (void)showImage:(UIImage *)image status:(NSString *)string {
    ...
    [[self sharedView] showImage:image status:string duration:2.0];
}
...
- (NSTimeInterval)displayDurationForString:(NSString*)string {
    return MIN((float)string.length * 0.05, 5.0);
}
...
#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 50000
    return [UIColor colorWithRed:222.0/255 green:219.0/255 blue:222.0/255 alpha:1.0];
#endif
...
- (UIColor *)hudRingForegroundColor {
#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 50000
    return [UIColor colorWithRed:25.0/255 green:148.0/255 blue:251.0/255 alpha:1];
#endif
