...
- (void)setupSubviews {
    ...
    _titleLabel.textColor = [UIColor colorWithWhite:1.f alpha:1.f];
    ...
    _subtitleLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:10.5f];
    _subtitleLabel.textColor = [UIColor colorWithWhite:1.f alpha:1.f];
...
+ (ALAlertBanner *)createAlertBannerForView:(UIView *)view style:(ALAlertBannerStyle)style position:(ALAlertBannerPosition)position title:(NSString *)title subtitle:(NSString *)subtitle {
    ...
    [alertBanner.titleLabel sizeToFit];
    [alertBanner.subtitleLabel sizeToFit];
...
- (void)drawRect:(CGRect)rect {
    ...
    switch (self.style) {
        case ALAlertBannerStyleSuccess:
            fillColor = [UIColor colorWithRed:(0/255.0) green:(140/255.0) blue:(72/255.0) alpha:.9f];
            break;
        case ALAlertBannerStyleFailure:
            fillColor = [UIColor colorWithRed:(213/255.0) green:(0/255.0) blue:(0/255.0) alpha:.9f];
            break;
        case ALAlertBannerStyleNotify:
            fillColor = [UIColor colorWithRed:(153/255.0) green:(188/255.0) blue:(211/255.0) alpha:1.f];
            break;
        case ALAlertBannerStyleWarning:
            fillColor = [UIColor colorWithRed:(211/255.0) green:(209/255.0) blue:(100/255.0) alpha:.9f];
            break;
    }
